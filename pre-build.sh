...
echo "#define __BUILD_NUMBER__      (${BUILDNUMBER}U)" >> $OUTPUT_FILENAME_HEADER
echo "#define __BUILD_DATEYEAR__    (${DATE_YEAR}U)" >> $OUTPUT_FILENAME_HEADER
echo "#define __BUILD_DATEMONTH__   (${DATE_MONTH##0}U)" >> $OUTPUT_FILENAME_HEADER
echo "#define __BUILD_DATEDAY__     (${DATE_DAY##0}U)" >> $OUTPUT_FILENAME_HEADER
echo "" >> $OUTPUT_FILENAME_HEADER
